...
assume  CS:CSEG, DS:CSEG
        org  100h
start:  mov  ax, 03h  ;video regim
        int  10h  
        mov cx,2607h  ;izmenit razmer kursora i ego symb i miganie
        mov ah,01h  ;set razmer kursora
        int 10h
...
printBorder proc
    ...
    mov ax, 0b800h ;text regim displ, nachalo okowka
    mov es, ax   
...
rows equ 18
coloumns equ 12 
instruction db "<- left $-> right$", 25," down  $", 24, " rotate$score:  $" 
